-- =============================================================================
-- [SAMPLE / CONTOH] REGISTER & SET OWNER USER
-- Untuk klien baru, disarankan menggunakan: supabase/seeds/register_user_template.sql
-- =============================================================================
...
DECLARE
    ...
    v_email TEXT := 'owner@tokocontoho.id';
    v_password TEXT := 'PasswordOwner123';
    v_full_name TEXT := 'Owner Toko Sembako';
...
BEGIN
    ...
    ELSE
        ...
        SET encrypted_password = crypt(v_password, gen_salt('bf', 10)),
            ...
            updated_at = NOW()
        WHERE id = v_user_id;
        RAISE NOTICE 'User auth ID: % berhasil diupdate passwordnya.', v_user_id;
    END IF;
    ...
    -- 4. Sinkronisasi Profile di public.profiles
    ...
    RAISE NOTICE 'SUCCESS: Akun Owner % berhasil dikonfigurasi!', v_email;
END $$;
