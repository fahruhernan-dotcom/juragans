...
export const BUSINESS_CATEGORIES = [
  {
    key: 'broker',
    label: 'Juragans & Distribusi',
    icon: '/assets/icons/models/distributor_sembako.png',
    description: 'Sistem POS Kasir, Multi-Gudang, Piutang & Manajemen Inventaris Bawang Goreng.',
  },
  {
    key: 'retail',
    label: 'Retail & Toko Juragans',
    icon: '/assets/icons/models/distributor_sembako.png',
...
export const BUSINESS_MODELS = {
  distributor_sembako: {
    ...
    category: 'broker',
    name: 'Juragans Dashboard & POS',
    label: 'Juragans Bawang Goreng',
    categoryLabel: 'Perdagangan',
    icon: '/assets/icons/models/distributor_sembako.png',
    description: 'Sistem POS Kasir, Multi-Gudang, Piutang Pelanggan, dan Inventaris Bawang Goreng Premium.',
    color: '#0F172A',
    themeColor: 'slate',
    user_type: 'broker',
  ...
  general_trading: {
    key: 'general_trading',
    category: 'broker',
    name: 'Juragans Trading & Retail',
    label: 'Juragans Trading',
    categoryLabel: 'Perdagangan',
    icon: '/assets/icons/models/distributor_sembako.png',
    description: 'Distribusi barang komersial dan retail multi-satuan Juragans.',
    color: '#0F172A',
    themeColor: 'slate',
    user_type: 'broker',
    sub_type: 'distributor_sembako',
