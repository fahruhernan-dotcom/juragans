        ...
        <div className="grid md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-6 bg-brand-cream/50 rounded-2xl p-6 border border-brand-maroon/10 space-y-4">
            ...
            <div className="bg-brand-maroon text-white p-4 rounded-xl flex items-center justify-between">
              ...
              <a
                href={getWaLink ? getWaLink('resellerCard', `Halo Juragans by Anak Bawang, saya ingin menanyakan syarat reseller grosir untuk pesanan ${qty} kg.`) : `https://wa.me/6282133731213?text=${encodeURIComponent(`Halo Juragans by Anak Bawang, saya ingin menanyakan syarat reseller grosir untuk pesanan ${qty} kg.`)}`}
                target="_blank"
