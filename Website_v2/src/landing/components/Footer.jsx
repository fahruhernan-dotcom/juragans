...
export default function Footer({ t, getWaLink, googleMapsUrl }) {
  return (
    <footer className="bg-brand-charcoal text-brand-cream/80 pt-16 pb-12 px-4 sm:px-6 lg:px-8 border-t border-brand-maroon/20 font-sans">
      <div className="max-w-7xl mx-auto grid md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-3 space-y-4">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/about-us" className="hover:text-brand-gold transition-colors">{t.menu.about}</Link></li>
            <li><Link to="/links" className="hover:text-brand-gold transition-colors">Link Bio & Official</Link></li>
      ...
      <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between text-xs text-brand-cream/50 space-y-4 sm:space-y-0">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link
            to="/login"
            className="text-[11px] font-semibold text-brand-cream/70 hover:text-brand-gold px-2.5 py-1 bg-white/5 hover:bg-white/10 rounded-lg transition-colors inline-flex items-center space-x-1"
          >
